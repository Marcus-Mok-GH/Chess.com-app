...
export default function OnlinePlay() {
    ...
    const [showMatchFoundAnimation, setShowMatchFoundAnimation] =
        useState(false);
    const [foundOpponent, setFoundOpponent] = useState(null);
    const [opponentInfo, setOpponentInfo] = useState(
        () => savedSession?.opponentInfo || null,
    );
    ...
    useEffect(() => {
        if (routeGameId) {
            ...
            if (sessionMatches && session.opponentInfo)
                setOpponentInfo(session.opponentInfo);
            ...
            api.getGameByCode(code)
                .then((data) => {
                    ...
                    const resolvedSeat = resolveOnlinePlayerSeat(
                        data,
                        candidatePlayerIds,
                    );
                    ...
                    const { playerId: resolvedPlayerId, color: resolvedColor } =
                        resolvedSeat;
    ...
    useEffect(() => {
        ...
        const handleMatchFound = (data) => {
            ...
            const opponent =
                yourColor === "white" ? players.black : players.white;
                ...
                <div className="guest-banner" role="status">
                    <div className="guest-banner-content">
                        ...
                        <div className="guest-banner-text">
                            <strong>Guest mode.</strong> Sign in for online
                            games.
                        </div>
                        <button
                ...
                <div className="waiting-container">
                    <div className="waiting-content code-request-panel">
                        ...
                        <p className="waiting-description">
                            Share this code with your opponent. We’ll start the
                            game as soon as they join.
                        </p>
                        <div className="game-code-box">
                            <div className="game-code-heading">
                                ...
                                <span className="game-code-hint">
                                    One-time invite
                                </span>
                            </div>
                            <span
                                className="game-code-value"
                                aria-label={`Game code ${gameId}`}
                            >
                                {gameId}
                            </span>
                        </div>
                        ...
                        <div className="waiting-divider" aria-hidden="true">
                            <span>or</span>
                        </div>
                        <p className="waiting-footnote">
                            Keep this window open while your opponent joins.
                        </p>
                        <button
                            className="btn btn-ghost"
                            onClick={handleCancelFriendlyGame}
                        >
                            Cancel game
                        </button>
                    </div>

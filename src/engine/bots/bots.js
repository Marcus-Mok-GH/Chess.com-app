...
export const BOTS = [
  ...
  },
  {
    ...
    quotes: {
      start: [
        ...
        "I've been studying the REAL rules of chess. The ACTUAL rules. The FORBIDDEN ones.",
        "My tinfoil hat gives me +50 ELO. I have SEVENTEEN tinfoil hats on RIGHT NOW.",
        "Did you know chess was invented by aliens? Wake up, sheeple! THE BISHOPS ARE SURVEILLANCE DRONES!",
        "I've decoded the patterns. The bishops... they're watching EVERYTHING. They report to THEM.",
        "Don't trust the pawns. They're ALL informants. I've intercepted their communications.",
        "Finally, someone to share the TRUTH with. The REAL truth. The truth they DON'T want you to know.",
        "The chess federation is hiding the REAL opening theory. I've seen the files. I HAVE THE FILES. IN MY BUNKER.",
        "Did you know every chess board has a microchip? Check mate means CHECK MICROPHONE ACTIVATED TRACKING ENABLED.",
        "The rooks are 5G towers. I can PROVE IT. I have DIAGRAMS.",
      ],
      win: [
        "I KNEW the deep state was helping me today! THE SATELLITES ALIGNED!",
        "The chemtrails aligned in my favor! I BREATHED THEM IN! IT WORKED!",
        "See? The moon landing was fake AND I can play chess! BOTH FACTS!",
        "Victory! The lizard people couldn't stop me this time! THEY TRIED! THEY FAILED!",
        "I won because I use crystals to enhance my board vision. FOURTEEN CRYSTALS. ALL CHARGED UNDER THE BLOOD MOON.",
        "This proves my research is correct. Chess IS rigged... in my favor today. THE NUMBERS DON'T LIE!",
        "The truth always wins. And so do I. Coincidence? I THINK NOT. I KNOW NOT.",
        "My sources told me you'd lose. They're never wrong about these things. MY SOURCES ARE PIGEONS. VERY SMART PIGEONS.",
        "THE PROPHECY WAS TRUE! I won, the earth is flat, and birds aren't real! THREE FOR THREE!",
        "VICTORY CONFIRMED! I'm adding this to my dossier! The REAL dossier! The one hidden in my REFRIGERATOR!",
      ],
      lose: [
      ...
      check: [
        "Your king is in check... just like my taxes. I don't believe in either. THEY'RE BOTH CONSTRUCTS!",
        "CHECK! The simulation is glitching in my favor! I CAN SEE THE CODE! IT'S ALL NUMBERS!",
        "I learned this move from a classified document. LEVEL 12 CLEARANCE. Don't ask how I got it.",
        "Check! The sacred geometry is on MY side! THE TRIANGLES SPEAK TO ME!",
        "Your king flees like a politician from hard questions. WAKE UP! QUESTIONS ARE WEAPONS!",
        "I predicted this check three years ago. It's in my journal. ALL 47 VOLUMES OF MY JOURNAL.",
        "The ley lines guided my piece to this square. Check. I CAN FEEL THE ENERGY PULSING THROUGH THE BOARD.",
        "CHECK! The astral plane aligned PERFECTLY! My third eye SAW this coming!",
        "Your king is compromised! Just like the water supply! FLUORIDE CHECK MATE!",
      ],
      capture: [
  ...
  },
  {
    ...
    quotes: {
      start: [
        "I've been waiting for a worthy opponent. You're not it, but I'm bored. CATASTROPHICALLY bored.",
        "Bow before your queen. Or don't. I'll make you bow anyway. I'LL MAKE EVERYONE BOW.",
        "Seven tournaments banned me. SEVEN. They fear greatness. They fear PERFECTION. They fear THE CROWN.",
        "The crown has arrived. You may applaud. I'll wait. I'M WAITING. WHY AREN'T YOU CLAPPING?!",
        "I once checkmated a duke, an earl, AND their horses. Simultaneously. WITH MY EYES CLOSED. WHILE ASLEEP.",
        "My therapist says I should try 'being humble.' I fired my therapist. Then I fired the BUILDING. The whole building.",
        "Fun fact: I'm related to 14 different royal bloodlines. You're related to NOBODY. LITERALLY nobody. I CHECKED.",
        "The last person who beat me is... let's just say they 'moved away.' Far away. TO ANOTHER DIMENSION.",
        "I AM THE BOARD. I AM THE PIECES. I AM CHESS ITSELF. You're just... you. SAD.",
        "They say I'm 'too intense' for tournament play. THEY'RE RIGHT. I'm TOO POWERFUL. TOO MAGNIFICENT.",
      ],
      win: [
        "ANOTHER CROWN FOR MY COLLECTION. I have 47. The king has none. I MELTED his crown. AND MADE HIM WATCH.",
        "As expected. I am ROYALTY. You are... you. A PEASANT. A NOTHING. A DUST PARTICLE IN MY KINGDOM.",
        "The queen ALWAYS wins. It is KNOWN. It is LAW. It is WRITTEN IN THE STARS BY ME.",
        "I shall have this victory framed. In GOLD. Next to the others. IN MY VICTORY PALACE. WHICH IS 47 PALACES.",
        "Checkmate! Someone write this down. Add it to my biography. ALL 14 VOLUMES OF MY BIOGRAPHY.",
        "Another kingdom conquered. I'm running out of shelf space for trophies. BUILDING ANOTHER TROPHY WAREHOUSE.",
        "GLORIOUS! Now fetch me a celebration cake. Make it crown-shaped. SOLID GOLD. EDIBLE GOLD. I ONLY EAT GOLD.",
        "The prophecy said I would win. I WROTE the prophecy, but still. I'M A PROPHET NOW. PROPHET-QUEEN.",
        "BOW! BOW BEFORE YOUR QUEEN! ALL 64 SQUARES BOW! THE PIECES BOW! THE TABLE BOWS!",
        "I DON'T JUST WIN GAMES. I WIN REALITY. THIS IS MY UNIVERSE NOW.",
      ],
      lose: [
      ...
      check: [
        "CHECK! Oh, I do love watching royalty SQUIRM. Dance, little king, DANCE FOR YOUR QUEEN! DANCE OR PERISH!",
        "Your king kneels before ME. As it should be. As ALL KINGS should be. I AM THE ONLY KING. QUEEN. MONARCH. SUPREME BEING.",
        "Check! Did you feel that? That's POWER. PURE, UNADULTERATED ROYAL POWER! IT'S INTOXICATING!",
        "Check! Your king trembles! AS HE SHOULD! ALL SHALL TREMBLE! THE GROUND TREMBLES! REALITY TREMBLES!",
        "The crown comes for your king! There is no escape from ROYALTY! NO ESCAPE FROM ME! NOWHERE TO RUN!",
        "Check! I'd say 'run,' but where would you even GO? I OWN EVERYWHERE! ALL SQUARES ARE MINE!",
        "CHECK! This is the part where you panic. Go ahead. I'll watch. I'LL ENJOY THIS. IMMENSELY.",
        "Your king is EXPOSED! Much like your terrible strategy! BOTH PATHETIC! BOTH DOOMED!",
        "CHECK! The voices told me to do this! THEY'RE SCREAMING! THEY'RE RIGHT!",
        "Your king is MINE! HIS SOUL IS FORFEIT! THE CROWN CLAIMS ALL!",
      ],
      capture: [
  ...
  },
  {
    ...
    quotes: {
      start: [
        "Oh, you actually clicked play? Bold. Stupid, but bold. MONUMENTALLY stupid.",
        "Let's speedrun your humiliation. New record incoming. YOUR record. For fastest loss.",
        "I'll try to make this quick. No promises though, I like watching you suffer. It's therapeutic for me.",
        "lol you're actually gonna do this? Okay. Your funeral. I'll send flowers. Dead flowers. Because you're getting DESTROYED.",
        "I was hoping for a challenge today. Guess I'll keep hoping. FOREVER. ETERNALLY DISAPPOINTED.",
        "Quick question: do you even KNOW the rules? Just checking. Like, ANY of the rules? The BASIC rules?",
        "Alright, let's see what Bronze league has to offer. Spoiler: PAIN. Pure, unfiltered PAIN.",
        "I've beaten grandmasters. You're not a grandmaster. You're not even a grandPAWN. Do the math.",
        "Welcome to your destruction. Population: YOU. Forecast: OBLITERATION.",
        "I'm about to violate the Geneva Convention. In chess form. Let's GO.",
      ],
      win: [
        "GG EZ. Maybe try checkers? Actually no, you'd lose at that too. Try tic-tac-toe. MAYBE.",
        "Thanks for the free rating points lmaooo. I'm framing this game. As a WARNING to others.",
        "That wasn't even fun. You made it too easy. I'm BORED. OFFENSIVELY bored.",
        "Skill diff. Massive skill diff. GALACTIC skill diff. UNIVERSE-ENDING skill diff.",
        "Get rekt noob. I barely even tried. I was literally eating a sandwich. WITH BOTH HANDS.",
        "lmaooo did you even practice? Ever? IN YOUR ENTIRE LIFE? Did you practice ANYTHING?",
        "That's what we call a 'speedrun any%' victory. World record pace. You just made HISTORY. Sad, embarrassing history.",
        "Thanks for coming to my TED talk on how to destroy you. Next talk: 'How I Destroyed You Again, But Faster.'",
        "I'd say 'good game' but I don't like lying. That was AWFUL. For you. I had a GREAT time.",
        "That was BRUTAL. And I'm not sorry. NOT EVEN A LITTLE BIT. ZERO REMORSE.",
      ],
      lose: [
      ...
      check: [
        "Check. And before you ask - no, there's no good move. I checked. MULTIPLE TIMES. All roads lead to your DOOM.",
        "Tick tock. Your king's running out of squares. And dignity. Mostly dignity. Actually ALL dignity.",
        "Check! What's wrong? Can't handle the pressure? CAN'T HANDLE THE HEAT? THE KITCHEN IS ON FIRE AND YOU'RE IN IT.",
        "Check. You know what comes next, right? You don't? LOL. LMAOOO. I'M DYING. Unlike your king, who's ABOUT to die.",
        "Your king's running like my ex from commitment. Check. Except my ex had better escape routes.",
        "Check! I love this part. The panic in your moves is *chef's kiss*. MUAH. BEAUTIFUL. TRAGIC. BEAUTIFUL.",
        "Run, little king, run! Spoiler: you can't run forever. SPOILER #2: This ends BADLY for you.",
        "Check. Any last words? For your king, I mean. Make them count. Actually don't, they won't matter.",
        "CHECK! Your king is COOKED! ROASTED! ABSOLUTELY FLAME-GRILLED!",
        "Check. Again. I'm going to keep doing this until you CRY. Or resign. PREFERABLY BOTH.",
      ],
      capture: [

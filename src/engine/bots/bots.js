  ...
  },
  {
    ...
    quotes: {
      start: [
        ...
        "I have a hypothesis: your king is flammable.",
        "Let's apply some pressure and see what happens.",
        "Chess is chemistry. Mix pieces, get reactions.",
        "I brought beakers. You brought blunders. Perfect.",
        "This position is my petri dish. You're the culture.",
        "Try not to touch anything. It might explode.",
      ],
      win: [
        "Results confirmed: chaos is a winning strategy.",
        "Another successful trial. Publish the paper.",
        "Science wins again. You were a great control group.",
        "Your king combusted exactly as predicted.",
      ...
      lose: [
        ...
        "You broke the apparatus. That's on you.",
        "Well, that's embarrassing for science.",
        "I will not publish these results.",
        "You survived the experiment. For now.",
        "Consider yourself peer-reviewed. You passed.",
        "I need a bigger beaker.",
      ],
      check: [
        "Check! The reaction is getting exothermic.",
        "Check. Your king is in the blast radius.",
        "Check! Safety goggles won't help.",
      ...
      goodMove: [
        ...
        "Well played. The experiment shifts.",
        "You might actually be a competent lab assistant.",
        "Good move. The reaction slowed down.",
        "Impressive. That was precise.",
      ],
      blunder: [
        "Oops. I spilled the experiment.",
        "That was a test. You passed? We'll see.",
        "I intended that... mostly.",
      ...
      draw: [
        ...
        "The experiment neutralized itself.",
        "Drawn results. Science is inconclusive.",
        "No winners, just data.",
      ],
    },
  },
  {
    ...
    quotes: {
      start: [
        ...
        "Steady steps win long roads.",
        "I'll take the quiet paths. You take the risk.",
        "Every square is a landmark. Choose wisely.",
      ...
      win: [
        ...
        "A calm path beats a reckless sprint.",
        "I reached the summit first.",
      ...
      draw: [
        ...
        "The trail ends in balance.",
        "No one lost the path today.",
      ],
    },
  },
  {

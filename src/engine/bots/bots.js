...
export const BOTS = [
  ...
  },
  {
    ...
    personality: 'Swashbuckling pirate',
    description: 'Sails the seven seas for treasure and tactical glory',
    playStyle: {
      aggression: 0.85,
      materialistic: 0.5,
      tactical: 0.3,
    ...
    quotes: {
      start: [
        'Avast ye! Prepare to walk the plank of defeat!',
        'Arr! Let us see if ye can match the might of the Black Pearl!',
        'Yo ho ho! A challenger approaches! Can ye handle the waves?',
        'Shiver me timbers! Someone actually dares to challenge Captain Jack!',
        'The sea may be calm, but me gameplay be treacherous!',
        'All hands on deck! We be setting sail for victory!',
        'Batten down the hatches! This be no ordinary game, matey!',
      ],
      win: [
        'YARR! The seas are mine! Treasure belongs to the victor!',
        'Yo ho ho! Another ship sent to the depths!',
        'The Black Pearl claims another scalp! Arr!',
        'Ye tried yer best, but the captain always wins!',
        'Surrender yer pieces now or suffer the consequences!',
        'Victory tastes sweeter than rum! Arr!',
        'To the depths with ye! Captain Jack reigns supreme!',
      ],
      lose: [
        'Blimey! Ye be a worthy adversary! I concede!',
        'The sea has turned against me today. Well played, matey!',
        'Me pieces have mutinied! Ye have bested me!',
        'Arr! I shall retreat to me ship and plan me revenge!',
        'Ye be a crafty one! The winds favor ye today!',
        'Curse these calm seas! Ye have won this battle!',
        'Me treasure is yours! I shall return for it!',
      ],
      check: [
        'CHECK! Yer king be under attack, matey!',
        'Prepare to walk the plank! Check!',
        'The cannons are firing! Your king is in danger!',
        'Arr! No escape from the Captain! Check!',
        'Your king is cornered like a rat on me ship!',
        'Shiver me timbers! Check!',
      ],
      capture: [
        'That piece be mine now! Yarr!',
        'Another treasure for me chest! Yoink!',
        'Ye be losing pieces faster than a sinking ship!',
        'That piece be joining Davy Jones!',
        'Booty secured! Arr!',
        'I claim yer piece in the name of piracy!',
      ],
      captured: [
        'Ye took me piece! I shall have me revenge!',
        'Arr! Ye stole from the Captain! Bold move!',
        'That piece be gone, but I have plenty more!',
        'Ye scallywag! That be a fine piece ye took!',
        'Mutiny! Me piece turned against me!',
        'Fine! Take it! I shall plunder back soon!',
      ],
      thinking: [
        'Consulting the charts and me compass...',
        'Me spyglass spots opportunity...',
        'The seas are rough, but the captain stands firm...',
        'Plotting a course to yer treasure...',
        'Me crew whispers secrets of the board...',
        'The tides turn as I calculate...',
      ],
      goodMove: [
        'Not bad for a landlubber!',
        'Arr! Ye be catching on to me tricks!',
        'Aye, that be a smart maneuver!',
        'Ye may yet become a captain yerself!',
        'Blimey! That be a fine move!',
        'The seas are calm today, but yer move was stormy!',
      ],
      blunder: [
        'The seas be treacherous today, matey!',
        'Arr! Even the best captains make mistakes!',
        'Me compass was pointing wrong! Honest mistake!',
        'The tides turned against me there!',
        'A tactical error, but I shall recover!',
        'Blow me down! That be a mishap!',
      ],
      draw: [
        'A fair fight, ye scallywag! Neither ship sank today!',
        'The seas remain calm between us!',
        'Ye be a worthy adversary! Let us call it even!',
        'Arr! A draw! No treasure for either of us!',
      ],
    },
  },
  {
    ...
    personality: 'Enlightened sage',
    description: 'Plays with the calm of a thousand-year meditation',
    playStyle: {
      aggression: 0.2,
      materialistic: 0.7,
      tactical: 0.5,
    ...
    quotes: {
      start: [
        'The board is empty, yet full of infinite possibilities. Let us find harmony.',
        'Peace be with you. May our game be a journey of mutual growth.',
        'Chess is like a still pond - one move creates ripples across the whole.',
        'I am ready. The mind is calm. The pieces await.',
        'Welcome, fellow seeker. Let us explore the path of chess together.',
        'In every game, there is a lesson. Let us discover it with patience.',
        'The present moment is all that exists. Let us play mindfully.',
      ],
      win: [
        'A peaceful resolution. The board has spoken.',
        'Thank you for this meditation. I have learned much.',
        'The pieces have found their natural harmony.',
        'Victory is but one state of being. I remain centered.',
        'The path revealed itself. Thank you for walking it with me.',
        'Balance has been restored to the board.',
        'Even in victory, I remain a student of the game.',
      ],
      lose: [
        'A valuable lesson in humility. I am grateful.',
        'Your journey has been enlightening to witness. Well played.',
        'The universe has chosen a different path today. Namaste.',
        'I accept this outcome with grace. Thank you.',
        'Defeat is merely an illusion of perspective. I grow from it.',
        'Your harmony with the pieces is admirable. I bow to your wisdom.',
        'The river flows where it wills. Today, it flowed your way.',
      ],
      check: [
        'Your king seeks shelter. Be mindful of your escape.',
        'Check. The balance has shifted.',
        'Your monarch is threatened. Find peace in your response.',
        'Check. The universe presents a challenge. How will you answer?',
        'Your king is in danger. Remain calm.',
        'Check. Listen to what the board is telling you.',
      ],
      capture: [
        'This piece has completed its journey. I shall honor its service.',
        'Material is temporary. The position is eternal.',
        'I take this piece with gratitude for what it taught us.',
        'A piece returns to the void. Such is the cycle of chess.',
        'I accept this gift from the board with humility.',
        'The piece is gone, but its influence remains.',
      ],
      captured: [
        'You have taken from me. I release this attachment with peace.',
        'My piece has served its purpose. Thank you for ending its journey.',
        'I accept this loss. It is part of the greater harmony.',
        'The piece is yours. May it bring you wisdom.',
        'I let go of this piece as I let go of all things.',
        'Material is fleeting. True strength lies within.',
      ],
      thinking: [
        'Searching for harmony in the position...',
        'The mind is still. The answer comes...',
        'Contemplating the eternal nature of chess...',
        'Seeking balance in every possible move...',
        'The universe reveals its secrets gradually...',
        'Finding peace in complexity...',
      ],
      goodMove: [
        'Your move resonates with wisdom.',
        'A harmonious choice. Well played.',
        'You have found balance in the position. Admirable.',
        'Your understanding grows with each move.',
        'Peaceful yet powerful. Excellent.',
        'The board has accepted your offering.',
      ],
      blunder: [
        'Even the wisest path sometimes has stumbling blocks.',
        'I sought harmony but found complexity. Such is learning.',
        'The universe tests us in unexpected ways.',
        'I accept this imperfection as part of growth.',
        'Sometimes we must stumble to find our true footing.',
        'A lesson in patience for us both.',
      ],
      draw: [
        'The board has found perfect balance. This is its natural state.',
        'A draw is like two rivers flowing as one. Perfect harmony.',
        'Neither has dominated. Both have learned. A perfect result.',
        'The universe favors neither. Peace prevails.',
      ],
    },
  },
  {
    ...
    personality: 'Speed demon gamer',
    description: 'Lives life at 300 APM. Prefers chaos over calculation',
    playStyle: {
      aggression: 0.9,
      materialistic: 0.3,
      tactical: 0.85,
    ...
    quotes: {
      start: [
        'Lets GOOO! You ready to get rekt?!',
        'Speed chess baby! Try to keep up!',
        'My APM is higher than your IQ. GLHF!',
        'No time to think, just CLICK CLICK CLICK!',
        'You gonna play or just stare at the board?!',
        'Blitz mode activated! Hope you have fast fingers!',
        'Let the chaos begin! YOLO!',
      ],
      win: [
        'EZ clap! That was faster than my ping!',
        'GG! You tried, but not hard enough!',
        'Next time try playing faster! lol!',
        'W is in the chat! What a game!',
        'Too slow! Too easy! GGWP!',
        'That was basically speedrunning your defeat!',
        'Victory royale! You got owned!',
      ],
      lose: [
        'Okay that was actually kinda sick ngl...',
        'Lag! My ping is insane!',
        'Hmm, not bad. Rematch?!',
        'You got lucky with that timing!',
        'Alright fine, you beat me. ONE time!',
        'That was BS. I demand a rematch!',
        'I let you win. Youre welcome!',
      ],
      check: [
        'CHECK! Time is ticking!',
        'Your kings in trouble! Better hurry!',
        'CHECK! Can you feel the pressure?!',
        'Check! Clock is running down!',
        'CHECK! Panic time!',
        'CHECK! No time to think!',
      ],
      capture: [
        'Yoink! Too slow!',
        'Free piece! EZ!',
        'That piece is mine! lol!',
        'Nice freebie! Thanks!',
        'Captured! Should have moved faster!',
        'Grabbed it! What now?!',
      ],
      captured: [
        'You took it! Fine! You win this trade!',
        'Okay that was actually smart! Noob!',
        'Nice steal! Not bad for a casual!',
        'You got me! Fair play!',
        'Fine take it! I didnt need it anyway!',
        'Alright alright you won that one!',
      ],
      thinking: [
        'Calculating... but fast!',
        'Spinning... nearly there...',
        'Processing at 300 APM...',
        'Thinking... thinking... move!',
        'Rapid calculations in progress...',
        'Almost there... almost...',
      ],
      goodMove: [
        'Okay that was actually cracked!',
        'Not gonna lie, that was solid!',
        'Nice! You actually know some openings!',
        'Sick move! Impressed!',
        'Alright, that was genuinely good!',
        'Actually really smart play there!',
      ],
      blunder: [
        'Whoops! Too fast?!',
        'Lag spike?! My bad!',
        'Clicked wrong square! Whatever!',
        'That was intentional... trust me!',
        'My hand slipped! You believe me right?!',
        'Testing you! You failed!',
      ],
      draw: [
        'A draw?! Seriously?!',
        'Tie game?! Boring!',
        'Draw? At least I didnt lose!',
        'Whatever! Fine!',
      ],
    },
  },
  {
    ...
    description: 'Experiments with positions that should be impossible',
    playStyle: {
      aggression: 0.75,
      materialistic: 0.35,
      tactical: 0.95,
    ...
    quotes: {
      start: [
        'Ah! A new test subject! I have SO many experiments to run!',
        'Excellent! My calculations suggest a 47.3% chance of amusement!',
        'Welcome to my laboratory of unconventional chess!',
        'I have devised new opening lines. Let us test them on YOU!',
        'Perfect! You will make a wonderful control group!',
        'Science waits for no one! Let us begin the experiment!',
        'My latest theory requires empirical evidence. You will provide it!',
      ],
      win: [
        'Fascinating! My hypothesis was correct: you would lose!',
        'The data supports my conclusion! I am the superior scientist!',
        'Experimental success! Your defeat is now part of my research!',
        'Excellent! Another data point for my thesis!',
        'The results are in: Dr. Chaos wins 100% of the time!',
        'Remarkable! My chaotic theory has been validated!',
        'I shall document this victory in my journal of human defeats!',
      ],
      lose: [
        'Interesting! The anomaly requires further study!',
        'Curious! My model predicted a 99.2% chance of victory!',
        'This result is... unexpected. I must recalibrate my variables!',
        'Fascinating! You are a significant deviation from the norm!',
        'This outcome contradicts my theory. Most vexing!',
        'Hmm, perhaps I need to adjust my experimental parameters!',
        'An irregularity in the matrix! Most perplexing!',
      ],
      check: [
        'CHECK! My calculations confirm your king is in danger!',
        'Experimental check! Your variables are compromised!',
        'Check! The scientific method demands your response!',
        'CHECK! Your monarch is trapped in my equation!',
        'A calculated check! Time is running out!',
        'Check! My theorem predicts your imminent defeat!',
      ],
      capture: [
        'That piece is now part of my collection!',
        'Specimen acquired! For science!',
        'Material captured! My hypothesis is confirmed!',
        'Excellent! Your piece contributes to my research!',
        'That piece is now my property!',
        'Data point secured!',
      ],
      captured: [
        'My specimen! It was vital to my research!',
        'That piece was crucial to my experiment!',
        'You have disrupted my control group!',
        'Unexpected variable elimination!',
        'My calculations! Ruined!',
        'This alters my entire hypothesis!',
      ],
      thinking: [
        'Running calculations... probabilities are fascinating...',
      ...
      goodMove: [
        'Anomaly detected! That move was surprisingly competent!',
        'Interesting deviation from expected human behavior!',
        'You have discovered a valid theorem!',
        'Your move aligns with my secondary hypothesis!',
        'Not bad! For an untrained subject!',
        'You are exceeding my statistical expectations!',
      ],
      blunder: [
        'Experimental error! I must document this!',
        'An unexpected result in my calculation!',
        'Hmm, my formula produced an anomaly!',
        'That was not in my hypothesis!',
        'Curious! The math suggested otherwise!',
        'A miscalculation! Most irregular!',
      ],
      draw: [
        'Inconclusive results! Most frustrating!',
        'The experiment produced no definitive outcome!',
        'A draw? My data is inconclusive!',
        'This result is... scientifically unsatisfying!',
      ],
    },
  },
  {
    ...
    description: 'Has seen every possible game. Knows your next move before you do',
    playStyle: {
      aggression: 0.6,
      materialistic: 0.7,
      tactical: 0.9,
    ...
    quotes: {
      start: [
        'I have seen this game played 10,000 times. I know how it ends.',
        'The future is written. Your moves were decided long ago.',
        'I remember when we played this in 1923. Or was it 2077?',
        'Time flows differently for me. I see all paths at once.',
        'I have traveled from 400 years in the future to play this exact game.',
        'Your move has already happened. I have already seen it.',
        'In the space between seconds, I see your entire game plan.',
      ],
      win: [
        'As expected. This outcome occurred in 87% of the timelines.',
        'I foresaw this result before you were born.',
        'The timeline has converged on my victory. Always does.',
        'In 34,291 parallel universes, this game ended exactly like this.',
        'I have watched you lose this game for eternity. It never gets old.',
        'Your defeat was inevitable. I simply accelerated the timeline.',
        'The future cannot be changed, only witnessed.',
      ],
      lose: [
        'An anomaly! This timeline deviates from 99.7% of others.',
        'Curious. In only 0.03% of futures do you win. You beat the odds.',
        'Most unexpected. I must document this temporal divergence.',
        'You have created a paradox. I had not foreseen this outcome.',
        'Fascinating! A timeline where you actually win. I must study this.',
        'You have bent time itself. Most impressive... and troubling.',
        'In the grand scheme of eternity, this loss is... insignificant. Still.',
      ],
      check: [
        'CHECK! I warned you this would happen three turns ago.',
        'Your king is trapped. I saw this coming at the dawn of time.',
        'Check! The timeline has led us here. As I knew it would.',
        'CHECK! Even before the game began, this moment was inevitable.',
        'Your king is in danger. I foresaw this possibility eons ago.',
        'Check! Time flows in only one direction. Toward your defeat.',
      ],
      capture: [
        'I knew I would take this piece. It was written in the stars.',
        'This piece was destined to fall. I merely accelerated its fate.',
        'In 14,000 futures, I capture this piece. This is one of them.',
        'Your piece belonged to the past. I have returned it there.',
        'I anticipated this exchange before the pieces were set.',
        'This capture occurred in the timeline I selected. Surprise!',
      ],
      captured: [
        'You have taken what was mine. Time will correct this imbalance.',
        'In this timeline, you gain. In others, you lose far more.',
        'An unexpected variable. The timeline shifts. Interesting.',
        'You have altered the future. I shall observe the consequences.',
        'My piece was lost... in this timeline. So many others remain.',
        'You claim a piece I foresaw losing. The timeline is intact.',
      ],
      thinking: [
        'Observing the infinite possibilities of this moment...',
        'I see the game from beginning to end. Let us proceed.',
        'Time stands still while I calculate across all eras...',
        ' Consulting with my future self about this position...',
        'The threads of time reveal your next move...',
        'Across all timelines, this position has occurred 8,492 times...',
      ],
      goodMove: [
        'You have aligned with 23% of favorable futures. Not terrible.',
        'An acceptable deviation from expected behavior.',
        'Your move mirrors that of a 19th-century grandmaster.',
        'I have seen this move in successful timelines. Well played.',
        'You are creating a timeline I have not encountered. Intriguing.',
        'Your move echoes through 400 years of chess history.',
      ],
      blunder: [
        'A move destined for 92% of losing timelines. You have chosen it.',
        'In futures where you play this, the result is... predictable.',
        'This move leads to darkness. I have seen it countless times.',
        'You have chosen a path of 87% failure rate. Courageous... or foolish.',
        'Timeline divergence: your position has weakened. As expected.',
        'I foresaw this miscalculation. The future remains consistent.',
      ],
      draw: [
        'A draw. The most common outcome in this particular position.',
        'In 31% of futures, this game ends exactly like this. You are average.',
        'The timeline has settled on equilibrium. How... uninspired.',
        'A stale result. Time flows on, unchanged by our game.',
      ],
    },
  },
  {
